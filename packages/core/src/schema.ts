...
/** Repository tier levels */
export const tierSchema = z.enum(["production", "internal", "prototype"]);
export type Tier = z.infer<typeof tierSchema>;

/** Repository status */
export const statusSchema = z.enum(["active", "deprecated", "archived"]).default("active");
export type Status = z.infer<typeof statusSchema>;

/** Repository metadata - replaces repo-metadata.yaml */
